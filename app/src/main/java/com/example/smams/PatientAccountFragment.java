...
public class PatientAccountFragment extends Fragment {
    ...
    private EditText editName, editEmail, editPhone, editBloodGroup, editKinName, editKinPhone;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_patient_account, container, false);
        ...
        editKinPhone = view.findViewById(R.id.edit_kin_phone);
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    editKinPhone.setText(snapshot.child("kinPhone").getValue(String.class));
    ...
    private void saveProfileChanges() {
        ...
        String kinPhone = editKinPhone.getText().toString().trim();
        ...
        userRef.child("kinPhone").setValue(kinPhone);
