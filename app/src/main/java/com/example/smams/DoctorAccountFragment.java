...
public class DoctorAccountFragment extends Fragment {
    ...
    private EditText editName, editEmail, editPhone, editBloodGroup, editWorkingHours;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        editWorkingHours = view.findViewById(R.id.editworkingHours);
        ...
        if (user != null) {
            ...
            userRef = FirebaseDatabase.getInstance().getReference("Doctors").child(userId);
            loadUserProfile();
        }
    ...
    private void enableEditing(boolean enable) {
        ...
        editWorkingHours.setEnabled(enable);
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    editBloodGroup.setText(snapshot.child("specialization").getValue(String.class));
                    editWorkingHours.setText(snapshot.child("workingHours").getValue(String.class));
    ...
    private void saveProfileChanges() {
        ...
        userRef.child("specialization").setValue(bloodGroup);
        userRef.child("workingHours").setValue(workingHours);
